...
import com.example.write.activity.ArticleActivity;
...
public class MyArticleAdapter extends RecyclerView.Adapter<MyArticleAdapter.ViewHolder> {
    ...
    public MyArticleAdapter(List<LitePalArticle> articleList,List<BbArticle> bArticleList){
